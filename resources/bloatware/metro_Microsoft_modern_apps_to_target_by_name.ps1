...
#Remove-App "Microsoft.BioEnrollment"                  # bloqueo por huella 
...
Remove-App "Microsoft.Windows.DevHome"
Remove-App "Microsoft.Windows.FeatureOnDemand.InsiderHub"
#Remove-App "Microsoft.WindowsAppRuntime.CBS"          # daña el explorador de archivos en windows 11
